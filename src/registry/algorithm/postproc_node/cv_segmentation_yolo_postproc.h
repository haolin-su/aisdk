#ifndef FIBO_CV_SEGMENTATION_YOLO_POSTPROC_H_
#define FIBO_CV_SEGMENTATION_YOLO_POSTPROC_H_
...
class YoloSegPostProcNode : public INode {
public:
    YoloSegPostProcNode() = default;
    ~YoloSegPostProcNode() = default;
    // INode() : INode(""), type_(NODE_TYPE_INPUT) {}
    YoloSegPostProcNode(const std::string& name) : INode(name) {}
...
// register_preprocess("PreProcess_Yolo_any", YoloSegPostProcNode, params_str);

} // namespace aisdk

#endif // FIBO_CV_SEGMENTATION_YOLO_POSTPROC_H_